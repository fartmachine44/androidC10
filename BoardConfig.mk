...
TARGET_BOARD_PLATFORM := a523-y83               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := false
TARGET_BOOTLOADER_BOARD_NAME := a523_y83_arm64     # From ro.product.board
...
BOARD_KERNEL_CMDLINE := loop.max_part=4 mmcblk.perdev_minors=16 firmware_class.path=/vendor/etc/firmware bootconfig androidboot.selinux=permissive
BOARD_KERNEL_BASE := 0x40078000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x03388000 --tags_offset 0xfff88100
...
TARGET_CPU_ABI2 :=
TARGET_CPU_VARIANT := cortex-a55             # Change the value to "generic" if build fails suddenly due to arch error
TARGET_2ND_ARCH := arm
TARGET_2ND_ARCH_VARIANT := armv7-a-neon
TARGET_2ND_CPU_ABI := armeabi-v7a
TARGET_2ND_CPU_ABI2 := armeabi
TARGET_2ND_CPU_VARIANT := cortex-a55         # Change the value to "generic" if build fails suddenly due to arch error
